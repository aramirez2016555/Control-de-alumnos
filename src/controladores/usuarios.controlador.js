...
function UserMaestro(req, res){
     ...
     .exec((err, adminoEncontrado )=>{
          ...
          if(adminoEncontrado.length >= 1){
               ...
               return console.log( "El MAESTRO siempre estuvo listo! ");
                    ...
                    bcrypt.hash("123456", null, null, (err, passwordEncriptada)=>{
                         ...
                         usuarioMode1.save((err, usuarioguardado) => {
                              ...
                              if(usuarioguardado){
                                   ...
                                   console.log({mensaje:"MAESTRO triste, no vino"})
...
function editarUsuario(req, res)
{
     ...
     if(req.user.rol === "ROL_MAESTRO"){
          ...
          if(req.user.rol=== "ROL_MAESTRO" && iDUsuario != req.user.sub  ){
               return res.status(500).send({mensaje: "Un maestro no puede editar usuarios"})
          ...
          if(req.user.rol=== "ROL_MAESTRO"    ){
               return res.status(500).send({mensaje: "Un maestro no puede editar su usuario, si desea alguna modificacion comuniquese con el administrador"})
          }
...
function EliminarUsuario(req, res)
{
     ...
     if(req.user.rol === "ROL_MAESTRO"){
          ...
          if(req.user.rol=== "ROL_MAESTRO"    ){
               return res.status(500).send({mensaje: "Un maestro no puede Eliminar su usuario, si desea alguna modificacion comuniquese con el administrador"})
          }
...
module.exports = {  registrarA ,registrarM, editarUsuario, login, UserMaestro,EliminarUsuario}
